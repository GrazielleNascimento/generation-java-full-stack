...
//nome, preço, qtdEstoque, plataforma, data de lançamento, descricao, desenvolvedora, faixa Etaria,genero lista de idiomas
		jogos.add(new Produto("The Legend of Zelda: Breath of the Wild", 
				350.00, 
				100, 
				new ArrayList<>(List.of("Nintendo")), 
				LocalDate.of(2017,03,05),
				...
				10,
				"Aventura",
				new ArrayList<>(List.of("inglês", "francês", "espanhol", "alemão", "italiano", "holandês", "russo", "japonês")),	
				10.00));
		
		jogos.add(new Produto("The Sims 5", 
				199.99, 
				 500, 
				new ArrayList<>(List.of("PC", "PlayStation 5", "Xbox Series X")), 
				...
				12,
				"Simulação de Vida",
				new ArrayList<>(List.of("Inglês", "Francês", "Alemão", "Espanhol", "Italiano", "Português", "Russo", "Chinês", "Japonês", "Coreano")),	
				10.00));
		
		jogos.add(new Produto("Age of Empires II", 
				15.00, 
				100, 
				new ArrayList<>(List.of("PC")), 
		...
		jogos.add(new Produto("Resident Evil 4",
                39.99,
                50,
                new ArrayList<>(List.of("PC", "PlayStation", "Xbox")),
                LocalDate.of(2005, 10, 25),
                "Um clássico jogo de survival horror que redefine a experiência de terror nos videogames.",
                "Capcom",
                18,
                "Survival Horror",
                new ArrayList<>(List.of("Inglês", "Espanhol", "Francês", "Alemão", "Italiano", "Português", "Japonês", "Coreano")),
                8.09));
		
		jogos.add(new Produto("Assassin's Creed",
                49.99,
                75,
                new ArrayList<>(List.of("PC", "PlayStation", "Xbox")),
		  ...
		  jogos.add(new Produto("Mortal Kombat",
	                59.99,
	                40,
	                new ArrayList<>(List.of("PC", "PlayStation", "Xbox", "Nintendo Switch")),
	                LocalDate.of(1992, 10, 8),
	                "Um clássico jogo de luta conhecido por seus personagens icônicos e combates sangrentos e intensos.",
	                "NetherRealm Studios",
	                18,
	                "Luta",
	                new ArrayList<>(List.of("Inglês", "Espanhol", "Francês", "Alemão", "Italiano", "Português", "Russo", "Chinês", "Japonês", "Coreano")),
	                8.00));
		  
		  jogos.add(new Produto("Crash Bandicoot",
	                29.99,
	                60,
	                new ArrayList<>(List.of("PlayStation", "Xbox", "Nintendo Switch")),
		  ...
		  jogos.add(new Produto("Guitar Hero",
	                39.99,
	                50,
	                new ArrayList<>(List.of("PlayStation", "Xbox", "Nintendo Switch")),
		  ...
		  jogos.add(new Produto("Plants vs. Zombies",
	                19.99,
	                80,
		  ...
		  jogos.add(new Produto("Devil May Cry",
	                49.99,
	                60,
	                new ArrayList<>(List.of("PC", "PlayStation", "Xbox", "Nintendo Switch")),
		  ...
		  jogos.add(new Produto("Need for Speed",
	                59.99,
	                70,
	                new ArrayList<>(List.of("PC", "PlayStation", "Xbox")),
		  ...
		  jogos.add(new Produto("Hellblade",
	                49.99,
	                40,
	                new ArrayList<>(List.of("PC", "PlayStation", "Xbox")),
