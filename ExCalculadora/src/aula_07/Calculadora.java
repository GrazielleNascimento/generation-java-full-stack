...
public class Calculadora {
	...
	public static void main(String[] args) {
		...
		if(opcao == 0) {/*Se for digitado a opção "0" exibe o "Sobre"*/
			sobre();
			System.exit(opcao);
		}
		...
		case 3 -> System.out.println("Miltiplicação: " + multiplicar(numero1, numero2));
	...
	/*Métodos com o mesmo nome e assinaturas diferentes, se trata de uma Sobrevarga de Método*/
	/*Aqui começa minha outra classe*/
	...
	static void sobre() {
		...
		System.out.println("Feito por:  Grazielle Nascimento!");		
	}
}
